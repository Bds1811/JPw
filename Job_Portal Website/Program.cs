...
builder.Services.AddDbContext<Job_PortalContext>(option => option.UseSqlServer(builder.Configuration.GetConnectionString("MyDBConnection")));

builder.Services.AddAutoMapper(typeof(Job_PortalContext));
